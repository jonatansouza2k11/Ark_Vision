...
import { 
    TRACKER_OPTIONS, type TrackerType 
...
export default function ZoneDrawer({
            ...
            if (modeValue === ZoneMode.QUEUE) {
                ...
                return {
                    ...
                    kpis: {
                        ...
                        show_avg_wait_time: typed.kpis?.show_avg_wait_time ?? true,
                        show_max_wait_time: typed.kpis?.show_max_wait_time ?? false,
                        show_abandon_rate: typed.kpis?.show_abandon_rate ?? true,
        ...
        setFormData(prev => {
            ...
            if (cfg) {
                ...
                if (!cfg.threshold_full) {
                    ...
                    updated.full_threshold = (updated.empty_threshold ?? 0) + 1;
                }
    ...
    useEffect(() => {
        ...
        if (canvasPoints.length >= 3) {
            ...
            setIsValidPolygon(false);
            setValidationMessage(
                `Adicione mais ${3 - canvasPoints.length} ponto(s) para completar o polígono.`
            );
        }
    ...
    const drawCanvas = useCallback(() => {
        ...
        if (canvasPoints.length >= 2) {
            ...
            if (canvasPoints.length >= 3) {
                ctx.closePath();
                ctx.fillStyle = `${formData.color || ZONE_MODE_COLORS[formData.mode]}33`;
                ctx.fill();
            }
                    ...
                    <div className="max-w-3xl mx-auto space-y-6">
                        ...
                        <div className="bg-white rounded-xl border-2 border-gray-200 p-6 space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <select
                                    value={(formData.metadata as any)?.trackeroverride ?? ""}
                                    onChange={e => {
                                        ...
                                        setFormData(prev => ({
                                            ...
                                            metadata: {
                                                ...prev.metadata,
                                                trackeroverride: value ? value : undefined,
                                            },
                                        }))
                                    }}
                                    ...
                                    disabled={mode === "view"}
                                >
                                    <option value="">Herdar tracker padrão da câmera</option>
                                ...
                                <p className="text-xs text-gray-500">
                                    {(formData.metadata as any)?.trackeroverride
                                        ? TRACKER_OPTIONS.find(
                                            o => o.value === (formData.metadata as any).trackeroverride,
                                        )?.description
                                ...
                                <div className="mt-4 pt-2 border-t border-gray-100 flex items-start justify-between gap-3">
                                    <div className="space-y-1">
                                        ...
                                        <p className="mt-1 text-sm text-gray-600">
                                            Quando ativado, só entram nas métricas desta zona os objetos que já
                                            tiverem um id global resolvido pelo rastreamento.
                                        </p>
                                    </div>
                                    ...
                                    <input
                                        ...
                                        disabled={mode === 'view'}
                                        checked={Boolean((formData.metadata as any)?.reid_required)}
                                        onChange={e =>
                                            setFormData(prev => ({
                                                ...prev,
                                                metadata: {
                                                    ...(prev.metadata || {}),
                                                    reid_required: e.target.checked,
                                                },
                                            }))
                                        }
                                    />
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => {
                                                        ...
                                                        if (value < minValue) {
                                                            warning(
                                                                `Threshold Cheio deve ser maior que ${formData.empty_threshold ?? 0}.`
                                                            );
                                                            return;
                                                        }
                                                        handleFieldChange(
                                ...
                                formData.mode === ZoneMode.CAPACITY && (
                                    <div className="bg-amber-50 border-2 border-amber-200 rounded-lg p-4">
                                        ...
                                        <p className="mt-2 text-sm text-amber-800 font-medium">
                                            📊 Lotação máxima:{' '}
                                            {formData.metadata?.max_capacity || 50} pessoas
                                        </p>
                                        ...
                                        <div className="mt-4 pt-4 border-t border-amber-300">
                                            ...
                                            <input
                                                ...
                                                onChange={e =>
                                                    setFormData(prev => ({
                                                        ...
                                                        metadata: {
                                                            ...(prev.metadata || {}),
                                                            alert_percentage: Number(e.target.value),
                                                        },
                                                    }))
                                                }
                                            ...
                                            <p className="mt-2 text-xs text-amber-700 bg-amber-100 px-3 py-2 rounded-lg border border-amber-300">
                                                ...
                                                <span className="font-bold">
                                                    {formData.metadata?.alert_percentage ?? 90}%
                                                </span>{' '}
                                                da capacidade (
                                                <span className="font-bold">
                                                    {Math.floor(
                                                        ((formData.metadata?.max_capacity ?? 50) *
                                                            (formData.metadata?.alert_percentage ?? 90)) /
                                                        100
                                                    )}
                                                </span>{' '}
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            {(['in', 'out', 'both'] as const).map(dir => (
                                                <label
                                                    key={dir}
                                                    className={`flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer ${formData.metadata?.count_direction === dir ||
                                                            (!formData.metadata?.count_direction &&
                                                                dir === 'both')
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        value={dir}
                                                        checked={
                                                            formData.metadata?.count_direction === dir ||
                                                            (!formData.metadata?.count_direction &&
                                                                dir === 'both')
                                                        }
                                                        onChange={() =>
                                        ...
                                        {formData.metadata?.alert_enabled && (
                                            <div className="ml-6 space-y-1">
                                                ...
                                                <p className="mt-1 text-xs text-blue-700 bg-blue-100 px-3 py-2 rounded-lg border border-blue-300">
                                                    Sistema enviará alerta por email quando contador
                                                    atingir{' '}
                                                    <span className="font-bold">
                                                        {formData.metadata?.alert_threshold ?? 100}
                                                    </span>{' '}
                                                    eventos.
                                                </p>
                                            </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="number"
                                                min={1}
                                                value={formData.metadata?.max_queue_length ?? 10}
                                                onChange={e =>
                                                    setFormData(prev => {
                                                        const value =
                                                            Number(e.target.value) || 1;
                                                        const warn =
                                                            prev.metadata?.warning_queue_length ??
                                                            Math.round(value * 0.7);
                                                        const crit =
                                                            prev.metadata?.critical_queue_length ??
                                                            value;
                                                        return {
                                                            ...prev,
                                                            metadata: {
                                                                ...
                                                                warning_queue_length: warn,
                                                                critical_queue_length: crit,
                                                            },
                                                        };
                                                    })
                                                }
                                            ...
                                            <p className="mt-1 text-xs text-indigo-700">
                                                Comprimento de fila considerado aceitável.
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                min={1}
                                                value={
                                                    formData.metadata?.warning_queue_length ??
                                                    Math.round(
                                                        (formData.metadata?.max_queue_length ?? 10) *
                                                        0.7
                                                    )
                                                }
                                                onChange={e =>
                                            ...
                                            />
                                            <p className="mt-1 text-xs text-indigo-700">
                                                A partir de quantas pessoas a fila entra em aviso.
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                min={1}
                                                value={
                                                    formData.metadata?.critical_queue_length ??
                                                    (formData.metadata?.max_queue_length ?? 10)
                                                }
                                                onChange={e =>
                                                    setFormData(prev => ({
                                            ...
                                            />
                                            <p className="mt-1 text-xs text-indigo-700">
                                                Comprimento de fila considerado crítico.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pt-3 border-t border-indigo-200">
                                        <div>
                                            ...
                                            <input
                                                type="number"
                                                min={0}
                                                value={formData.metadata?.max_wait_warning ?? 120}
                                                onChange={e =>
                                                    setFormData(prev => ({
                                                        ...prev,
                                                        metadata: {
                                            ...
                                            />
                                            <p className="mt-1 text-xs text-indigo-700">
                                                Tempo médio de espera para sinalizar fila alta.
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="number"
                                                min={0}
                                                value={formData.metadata?.max_wait_critical ?? 300}
                                                onChange={e =>
                                                    setFormData(prev => ({
                                                        ...prev,
                                                        metadata: {
                                            ...
                                            />
                                            <p className="mt-1 text-xs text-indigo-700">
                                                Tempo máximo de espera aceitável antes de
                                                marcar fila como crítica.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pt-3 border-t border-indigo-200">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                step={0.1}
                                                value={
                                                    formData.metadata?.queue_join_confirm_time ??
                                                    1
                                                }
                                                onChange={e =>
                                                    setFormData(prev => ({
                                            ...
                                            />
                                            <p className="mt-1 text-xs text-indigo-700">
                                                Tempo mínimo que o objeto deve permanecer dentro da
                                                zona para ser considerado na fila.
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                step={0.1}
                                                value={
                                                    formData.metadata?.queue_leave_grace_time ??
                                                    2
                                                }
                                                onChange={e =>
                                                    setFormData(prev => ({
                                            ...
                                            />
                                            <p className="mt-1 text-xs text-indigo-700">
                                                Tempo que o objeto pode ficar fora da zona antes de
                                                ser considerado saída definitiva/abandono.
                                            </p>
                                        </div>
                                    </div>
